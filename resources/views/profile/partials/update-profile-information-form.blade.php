<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Ubah dan Lengkapi data Saudara/i.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $user->nama_pegawai)" autocomplete="name" />
        ...
        <div>
            ...
            <x-text-input
                ...
                placeholder="{{ $user->alamat ? '' : 'Alamat belum diisi' }}"
                autocomplete="alamat"
            />
