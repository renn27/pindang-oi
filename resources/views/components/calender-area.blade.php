    ...
    <div class="fixed inset-0 z-99999 flex items-center justify-center p-5 modal hidden" id="eventModal">
        ...
        <div
            ...
            <div class="px-6 pt-6 lg:px-11">
                <h5 class="mb-2 font-semibold text-gray-800 text-theme-xl lg:text-2xl">
                    Add Event
                </h5>
            ...
            <div
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <input id="event-title" type="text" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden" placeholder="Enter event title" />
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative">
                            <input id="event-start-date" type="date" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden" onclick="this.showPicker()" />
