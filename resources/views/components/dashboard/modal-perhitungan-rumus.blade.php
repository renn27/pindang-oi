                            ...
                            <div class="rounded-xl border border-brand-200 bg-gradient-to-r from-brand-50 to-blue-50 p-4 dark:border-brand-800/40 dark:from-gray-800 dark:to-gray-800 flex flex-wrap gap-4 items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 space-y-0.5">
                                        <span>Base: <span class="font-mono" x-text="calcData.breakdown.rata_rata_base + '%'"></span> <span class="text-[10px] text-gray-400 dark:text-gray-500 font-sans" x-text="calcData.breakdown.is_katim ? '(F5)' : '((F1+F2+F3+F4)/4)'"></span></span>
                                ...
                                <div class="grid grid-cols-2 gap-2 text-xs">
                                    <div class="rounded-lg bg-white/70 dark:bg-gray-700/50 px-3 py-2 text-center border border-gray-100 dark:border-gray-700">
                                        <div class="text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-0.5" x-text="calcData.breakdown.is_katim ? 'Jml Sub Kegiatan Tim' : 'Jml Penugasan'"></div>
                                        <div class="font-bold text-gray-800 dark:text-white" x-text="calcData.breakdown.is_katim ? calcData.breakdown.total_sub_kegiatan : calcData.breakdown.total_penugasan_dia"></div>
                                    </div>
                                    <div class="rounded-lg bg-white/70 dark:bg-gray-700/50 px-3 py-2 text-center border border-gray-100 dark:border-gray-700">
                                        <div class="text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-0.5" x-text="calcData.breakdown.is_katim ? 'Total Target Tim' : 'Target Pegawai'"></div>
                                        <div class="font-bold text-gray-800 dark:text-white" x-text="calcData.breakdown.is_katim ? calcData.breakdown.total_target_tim : calcData.breakdown.target_pegawai"></div>
                                    </div>
                                    <div class="rounded-lg bg-white/70 dark:bg-gray-700/50 px-3 py-2 text-center border border-gray-100 dark:border-gray-700">
                                        <div class="text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-0.5" x-text="calcData.breakdown.is_katim ? 'Avg Target Tim Bulanan' : 'Avg Target Bulan'"></div>
                                        <div class="font-bold text-gray-800 dark:text-white" x-text="calcData.breakdown.is_katim ? calcData.breakdown.avg_target_tim : calcData.breakdown.avg_target_bulan"></div>
                                    </div>
                                    <div class="rounded-lg bg-purple-50 dark:bg-purple-900/20 px-3 py-2 text-center border border-purple-200 dark:border-purple-800/40">
                                        <div class="text-purple-600 dark:text-purple-400 uppercase tracking-wider mb-0.5" x-text="calcData.breakdown.is_katim ? 'Koef Beban Tim' : 'Koefisien Beban'"></div>
                                        <div class="font-bold text-purple-700 dark:text-purple-300" x-text="calcData.breakdown.koefisien_beban + 'x'"></div>
                                    </div>
                                </div>
                            </div>

                            <template x-if="!calcData.breakdown.is_katim">
                                <div class="space-y-4">
                                    <!-- F1: Penyelesaian -->
                                        ...
                                        <div class="mt-2 text-xs font-mono text-amber-700 dark:text-amber-400 border-t border-amber-200 dark:border-amber-800/30 pt-2">
                                            ...
                                            <template x-if="calcData.breakdown.f3.detail.some(d => !d.is_active_month && d.bulan_pengiriman)">
                                                <div class="mt-1 text-[10px] text-gray-500 dark:text-gray-400 italic font-sans">
                                                    * Catatan: Baris berwarna abu-abu adalah penugasan aktif yang progresnya sudah dilaporkan and dinilai pada bulan terkait, sehingga bobot dan kontribusinya bernilai 0 pada bulan evaluasi aktif ini.
                                                </div>
                                            </template>
                                        </div>
                                    </div>
                                ...
                                <div class="rounded-xl border border-indigo-200 bg-indigo-50/50 dark:border-indigo-800/30 dark:bg-indigo-900/10 p-4">
                                    <div class="flex items-center justify-between mb-3">
                                        <h4 class="font-bold text-indigo-800 dark:text-indigo-300 flex items-center gap-2">
                                            ...
                                            F5 — Kinerja Pengawasan Tim <span class="text-xs font-normal text-indigo-600 dark:text-indigo-400">(bobot 100%)</span>
                                        </h4>
