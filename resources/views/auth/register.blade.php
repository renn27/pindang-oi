            ...
            <form method="POST" action="{{ route('register') }}" class="px-6 py-6">
                ...
                <div class="mb-6">
                    <div class="flex items-center mb-4">
                        <div class="h-8 w-1 bg-[#465fff] rounded-r mr-2"></div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-2.5 flex items-center pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-[#465fff]"
                                ...
                                <x-text-input id="name" class="block mt-1 w-full pl-9 text-sm py-2" type="text"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="jabatan" class="block mt-1 w-full pl-9 text-sm py-2" type="text"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="email" class="block mt-1 w-full pl-9 text-sm py-2" type="email"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="password" class="block mt-1 w-full pl-9 text-sm py-2"
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <x-text-input id="password_confirmation" class="block mt-1 w-full pl-9 text-sm py-2"
                ...
                <div class="flex flex-col md:flex-row items-center justify-between mt-8 pt-6 border-t border-gray-200">
                    <div class="mb-4 md:mb-0">
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center text-[#465fff] hover:text-[#3a4fd9] font-medium text-sm transition-colors group">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 mr-1.5 group-hover:translate-x-1 transition-transform"
                                viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd"
