                    ...
                    <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead>
                            <tr class="bg-gray-50 dark:bg-gray-800">
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-400 uppercase tracking-wider">
                                    No.
                                </th>
                                <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-400 uppercase tracking-wider">
                                    Nama
                            ...
                            @forelse ($penugasanButuhDL as $penugasan)
                                ...
                                <tr class="border-l-4 {{ $borderColor }} {{ $isMe ? 'bg-blue-50/50 dark:bg-blue-900/20' : 'hover:bg-gray-50 dark:hover:bg-gray-800' }}">
                                    ...
                                    <td class="px-6 py-3 text-sm text-gray-700 dark:text-gray-400 text-center">
                                        ...
                                        <div class="text-xs text-gray-500 dark:text-gray-400">{{ $penugasan->satuan_target ?? '-' }}</div>
                                    </td>
                                    ...
                                    <td class="px-6 py-3 text-center">
                                        ...
                                        <span class="inline-flex px-2 py-1 text-xs font-medium rounded-full
                                            {{ $dlStatus === 'ACC' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' :
                                            ($dlStatus === 'Ditolak' ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400' :
                                                    ...
                                                    <div class="pt-3 border-t border-gray-100 dark:border-gray-700">
                                                        <div class="flex items-center justify-between">
                                                            ...
                                                            <div class="text-center">
                                                                ...
                                                                <div
                                                                    ...
                                                                    @foreach ($penugasan->bintang_kirim_array as $filled)
                                                                        <span class="{{ $filled ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-500' }}">
                                                                            ★
                                                                        </span>
                                                                    @endforeach
                                                            ...
                                                            <div class="text-right">
                                                                <p class="text-xs text-gray-500 dark:text-gray-400">Bukti</p>
                                ...
                                <tr>
                                    <td colspan="10" class="px-6 py-8 text-center">
                                        <div class="flex flex-col items-center justify-center text-gray-400 dark:text-gray-500">
                                            ...
                                            <p class="text-base font-medium text-gray-500 dark:text-gray-400 mb-1">Belum ada penugasan</p>
