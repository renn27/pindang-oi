                            ...
                            <tr class="bg-gray-50 border-t-2 border-gray-200">
                                ...
                                <td colspan="3" class="px-6 py-3 text-center">
                                    <div class="inline-flex flex-col items-center">
                                        ...
                                        <span class="text-base font-bold text-blue-600">{{ $totalKirimButuhDL }}</span>
                                    </div>
                                </td>
                                <td colspan="4" class="px-6 py-3 text-center">
                                    <div class="inline-flex flex-col items-center">
                                        <span class="text-sm font-semibold text-gray-700">Penerimaan</span>
                                        <span class="text-base font-bold text-green-600">{{ $totalTerimaButuhDL }}</span>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="bg-gray-50 border-t-2 border-gray-200">
                                ...
                                <td colspan="3" class="px-6 py-3 text-center">
                                    <div class="inline-flex flex-col items-center">
                                        <span class="text-sm font-semibold text-gray-700">Pengiriman</span>
                                        <span class="text-base font-bold text-blue-600">{{ $totalKirimTidakButuhDL }}</span>
                                    </div>
                                </td>
                                <td colspan="4" class="px-6 py-3 text-center">
                                    <div class="inline-flex flex-col items-center">
                                        <span class="text-sm font-semibold text-gray-700">Penerimaan</span>
                                        <span class="text-base font-bold text-green-600">{{ $totalTerimaTidakButuhDL }}</span>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
