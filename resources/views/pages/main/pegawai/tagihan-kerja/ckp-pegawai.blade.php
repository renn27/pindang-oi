                ...
                <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead>
                        <tr class="bg-gray-50 dark:bg-gray-800">
                            <th
                                class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-10 dark:text-gray-400">
                                No.</th>
                            <th
                                class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400">
                                Uraian Kegiatan</th>
                            <th
                                class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-24 dark:text-gray-400">
                                Jenis CKP</th>
                            <th
                                class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-20 dark:text-gray-400">
                                Satuan</th>
                            <th
                                class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-20 dark:text-gray-400">
                                Target</th>
                            <th
                                class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-28 dark:text-gray-400">
                                Kode Butir</th>
                            <th
                                class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-24 dark:text-gray-400">
                                Angka Kredit</th>
                            <th
                                class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-36 dark:text-gray-400">
                                Keterangan</th>
                            <th
                                class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-14 dark:text-gray-400">
                                Aksi</th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-900 dark:divide-gray-700">
                        @forelse ($ckpList as $index => $ckp)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800">
                                ...
                                <td class="px-4 py-3 text-center whitespace-nowrap">
                                    ...
                                    {{ $ckp->jenis_ckp == 'utama' ? 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400' : 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400' }}">
                                        {{ ucfirst($ckp->jenis_ckp ?? 'Utama') }}
                                    </span>
                                </td>
    ...
    ">
        ...
        <x-ui.smart-modal id="modal-detail-ckp" class="max-w-2xl">
            <div class="relative flex flex-col bg-white dark:bg-gray-900 dark:border dark:border-gray-800 rounded-3xl overflow-hidden"
                ...
                {{-- HEADER (seragam dengan modal edit) --}}
                ...
                <div class="flex-1 overflow-y-auto px-6 py-5 space-y-4 custom-scrollbar dark:bg-gray-900">
                    ...
                    {{-- 3 metric cards: Jenis, Target, Angka Kredit --}}
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <div class="rounded-xl bg-gray-50 dark:bg-gray-800 p-3">
                            <p class="text-xs font-medium text-gray-400 dark:text-gray-500 mb-1">Target</p>
                ...
                {{-- FOOTER (seragam dengan modal edit) --}}
