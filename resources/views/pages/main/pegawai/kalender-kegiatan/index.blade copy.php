    ...
    <div class="p-4 md:p-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <div
                    class="flex items-center gap-2 bg-white dark:bg-gray-800 rounded-xl border dark:border-gray-700 p-1 shadow-sm">
        ...
        <div class="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div
                class="bg-gradient-to-br from-purple-50 to-white dark:from-gray-800 dark:to-gray-900 p-4 rounded-2xl border border-purple-100 dark:border-gray-700 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-8 flex justify-end gap-3">
                            <button id="edit-event"
                                class="px-5 py-2.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 font-medium transition-colors flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <button id="delete-event"
                                class="px-5 py-2.5 bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-600 text-white rounded-xl font-medium transition-all duration-200 flex items-center gap-2 shadow-lg hover:shadow-xl">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div id="add-event-modal"
            class="fixed inset-0 bg-black/60 backdrop-blur-sm hidden z-50 flex items-center justify-center p-4">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg transform transition-all duration-300 scale-95 opacity-0"
                ...
                <div class="p-6">
                    ...
                    <form id="event-form" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="title"
                                    class="w-full border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 focus:border-blue-500 dark:focus:border-blue-600 transition-all duration-200"
                                    placeholder="Masukkan judul kegiatan" required>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Jenis
                                    Kegiatan</label>
                                <select name="category"
                                    class="w-full border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 focus:border-blue-500 dark:focus:border-blue-600 transition-all duration-200 appearance-none">
                                    <option value="meeting" data-color="bg-gradient-to-r from-blue-500 to-blue-400">Rapat
                                    </option>
                                    <option value="dinas" data-color="bg-gradient-to-r from-green-500 to-green-400">Dinas
                                        Luar</option>
                                    <option value="training" data-color="bg-gradient-to-r from-purple-500 to-purple-400">
                                        Pelatihan</option>
                                    <option value="leave" data-color="bg-gradient-to-r from-yellow-500 to-yellow-400">
                                        Cuti</option>
                                    <option value="deadline" data-color="bg-gradient-to-r from-red-500 to-red-400">
                                        Deadline</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div>
                            <label
                                class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Peserta</label>
                            <div class="flex flex-wrap gap-2 mb-3 min-h-12 p-2 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 rounded-xl"
                                id="participants-list"></div>
                            <div class="flex gap-2">
                                <input type="text" id="participant-input" placeholder="Nama peserta"
                                    class="flex-1 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-600 focus:border-blue-500 dark:focus:border-blue-600 transition-all duration-200">
                        ...
                        <div class="flex justify-end gap-3 pt-4 border-t dark:border-gray-700">
                            <button type="button" id="cancel-add"
                                class="px-5 py-3 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 font-medium transition-all duration-200">
                                Batal
                            </button>
                            <button type="submit"
                                class="px-5 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 dark:from-blue-500 dark:to-blue-600 dark:hover:from-blue-600 dark:hover:to-blue-700 text-white rounded-xl font-medium transition-all duration-200 transform hover:-translate-y-0.5 shadow-lg hover:shadow-xl">
                                Simpan Kegiatan
                            </button>
                        </div>
                    </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createDateCell(date, day) {
                ...
                addButton.className =
                    'opacity-0 group-hover:opacity-100 text-gray-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-gray-700 h-7 w-7 rounded-full flex items-center justify-center transition-all duration-200';
                addButton.innerHTML =
            ...
            function createEventElement(event, showTitle = true) {
                ...
                eventDiv.className =
                    `rounded-lg px-2.5 py-1.5 text-xs cursor-pointer truncate ${category.bgColor} border-l-4 border-l-transparent hover:shadow-sm transition-all duration-200 group`;
            ...
            function showEventDetails(event) {
                ...
                modalHeaderBar.className =
                    `absolute top-0 left-0 right-0 h-2 rounded-t-2xl bg-gradient-to-r ${category.color}`;
            ...
            function updateParticipantsList() {
                ...
                eventParticipantsList.forEach(participant => {
                    const badge = document.createElement('span');
                    badge.className =
                        'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/10 text-blue-800 dark:text-blue-400 border border-blue-200 dark:border-blue-800/30';
                    badge.innerHTML = `
                ${participant}
            ...
            function updateStats() {
                ...
                const total = events.reduce((sum, event) => sum + (event.participants ? event.participants.length :
                    0), 0);
