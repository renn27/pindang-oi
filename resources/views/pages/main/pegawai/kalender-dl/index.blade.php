    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        ...
        <form method="GET" action="{{ route('kalenderDL.index') }}"
            ...
            <div>
                ...
                <select name="month" class="border dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-md px-3 py-2 text-sm focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-600">
                    @for($m = 1; $m <= 12; $m++)
            ...
            <div>
                ...
                <select name="year" class="border dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-md px-3 py-2 text-sm focus:ring-1 focus:ring-blue-500 dark:focus:ring-blue-600">
        ...
        <div class="w-full overflow-x-auto lg:overflow-x-hidden">
            <table class="w-full border-collapse table-fixed text-[11px] lg:text-[12px] dark:divide-gray-700">
                ...
                <thead class="bg-gray-50 dark:bg-gray-900 sticky top-0 z-20">
                    <tr>
                        {{-- Pegawai --}}
                        <th class="border-b dark:border-gray-700 px-3 py-2 text-left font-semibold text-gray-700 dark:text-gray-300 w-[180px]">
                            Pegawai
                        </th>

                        {{-- Total --}}
                        <th class="border-b dark:border-gray-700 px-2 py-2 text-center font-semibold text-gray-700 dark:text-gray-300 w-[60px]">
                            Total
                        </th>

                        {{-- Tanggal --}}
                        @foreach($dates as $date)
                            <th class="border-b dark:border-gray-700 px-0.5 py-2 text-center
                                w-[34px] lg:w-[26px]">
                                <div class="font-semibold text-gray-800 dark:text-gray-300 leading-tight text-[11px] lg:text-[10px]">
                                    {{ $date->format('d') }}
                                </div>
                                <div class="text-gray-500 dark:text-gray-400 uppercase leading-tight text-[9px] lg:text-[8px]">
                ...
                <tbody>
                    @foreach($pegawais as $pegawai)
                        ...
                        <tr class="hover:bg-blue-50 dark:hover:bg-gray-700 transition h-[34px]">
                            ...
                            {{-- Nama --}}
                            <td class="border-b dark:border-gray-700 px-3 py-1 font-medium text-gray-800 dark:text-gray-300 truncate">
                            ...
                            <td class="border-b dark:border-gray-700 px-2 py-1 text-center">
                                @if($pegawai->total_dl_bulan_ini > 0)
                                    <span class="inline-flex items-center justify-center bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 px-2 py-0.5 rounded-full text-[11px] font-semibold">
                                        {{ $pegawai->total_dl_bulan_ini }}
                                    </span>
                                @else
                                    <span class="inline-flex items-center justify-center bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 px-2 py-0.5 rounded-full text-[11px] font-semibold">
                                        0
                                    </span>
                                @endif
                            </td>
