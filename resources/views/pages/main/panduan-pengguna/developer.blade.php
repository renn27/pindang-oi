                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                        <template x-if="activeGuide.controller_path">
                                            <div class="p-3 bg-gray-50 dark:bg-gray-800/40 rounded-xl border border-gray-150 dark:border-gray-800">
                                                <span class="text-[10px] font-extrabold uppercase text-gray-400 dark:text-gray-500 tracking-wider">Controller</span>
                                                <div class="font-mono text-xs text-gray-800 dark:text-gray-200 mt-1 select-all" x-text="activeGuide.controller_path"></div>
                                            </div>
                                        </template>
                                        <template x-if="activeGuide.model_path">
                                            <div class="p-3 bg-gray-50 dark:bg-gray-800/40 rounded-xl border border-gray-150 dark:border-gray-800">
                                                <span class="text-[10px] font-extrabold uppercase text-gray-400 dark:text-gray-500 tracking-wider">Model</span>
                                                <div class="font-mono text-xs text-gray-800 dark:text-gray-200 mt-1 select-all" x-text="activeGuide.model_path"></div>
                                            </div>
                                        </template>
                                        <template x-if="activeGuide.view_path">
                                            <div class="p-3 bg-gray-50 dark:bg-gray-800/40 rounded-xl border border-gray-150 dark:border-gray-800">
                                                ...
                                                <div class="font-mono text-xs text-gray-800 dark:text-gray-200 mt-1 select-all" x-text="activeGuide.view_path"></div>
                                            </div>
                                        </template>
                                        <template x-if="activeGuide.route_definition">
                                            <div class="p-3 bg-gray-50 dark:bg-gray-800/40 rounded-xl border border-gray-150 dark:border-gray-800">
                                                ...
                                                <div class="font-mono text-xs text-gray-800 dark:text-gray-200 mt-1 select-all" x-text="activeGuide.route_definition"></div>
                                            </div>
                                        </template>
                                        <template x-if="activeGuide.policy_gate">
                                            <div class="p-3 bg-gray-50 dark:bg-gray-800/40 rounded-xl border border-gray-150 dark:border-gray-800">
                                                ...
                                                <div class="font-mono text-xs text-gray-800 dark:text-gray-200 mt-1 select-all" x-text="activeGuide.policy_gate"></div>
                                            </div>
                                        </template>
                                        <template x-if="activeGuide.middleware">
                                            <div class="p-3 bg-gray-50 dark:bg-gray-800/40 rounded-xl border border-gray-150 dark:border-gray-800">
                                                ...
                                                <div class="font-mono text-xs text-gray-800 dark:text-gray-200 mt-1 select-all" x-text="activeGuide.middleware"></div>
                                            </div>
                                        </template>
                                    </div>
                                </div>

                                {{-- Langkah Penggunaan / Tutorial / Code Snippets --}}
                                <div class="space-y-3 bg-gray-900 text-gray-200 p-4 rounded-xl border border-gray-800">
                                    <h3 class="text-sm font-bold text-indigo-400 uppercase tracking-wider">Implementasi Kode &amp; Contoh Workflow</h3>
                                    <div class="text-sm leading-relaxed" x-html="activeGuide.tutorial"></div>
                                </div>
