...
@section('content')
    ...
    <div x-data="{
        ...
        filterAnnouncements() {
            const allAnnouncements = {{ Js::from(
                $announcements->map(function ($item) {
                    ...
                    return [
                        ...
                        'image_url' => $item->image_path ? 'https://pindangoi.bpsoganilir.com/storage/' . $item->image_path : null,
        ...
        closeDetail() {
            // JANGAN langsung null-kan selectedAnnouncement
            this.showDetailModal = false;
            document.body.style.overflow = 'unset';
    
            // Delay penghapusan data sampai animasi selesai
            setTimeout(() => {
                this.selectedAnnouncement = null;
            }, 300); // Durasi sama dengan leave animation
        },
                        ...
                        <div @click="openDetail(announcement, index)"
                            ...
                            <div class="p-4">
                                ...
                                <div
                                    ...
                                    <span
                                        class="text-xs text-brand-600 opacity-0 transition-opacity group-hover:opacity-100 dark:text-brand-400">
                                        Lihat Detail →
                                    </span>
                                </div>
                            </div>
            ...
            <template x-if="filteredAnnouncements.length === 0">
                <div class="py-12 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400"
                        x-text="activeTab === 'active' ? 'Tidak ada pengumuman aktif' : (activeTab === 'inactive' ? 'Tidak ada pengumuman nonaktif' : 'Belum ada pengumuman')">
                    </p>
                </div>
            </template>
        </div>
        ...
        <div x-show="showDetailModal" x-cloak>
            <div class="modal fixed inset-0 z-99999 flex items-center justify-center overflow-hidden p-4"
                ...
                <div @click="closeDetail()"
                    ...
                    x-show="showDetailModal" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="relative flex items-center justify-center"
                    ...
                    <div @click.stop
                        ...
                        x-show="showDetailModal" x-transition:enter="transition-all duration-500 ease-out"
                        ...
                        <div class="relative shrink-0 border-b border-gray-200 px-4 py-3 dark:border-gray-700">
                            <div class="flex items-center gap-2">
                                <div
                                    ...
                                    <svg class="h-4 w-4 text-brand-600 dark:text-brand-400" fill="none"
                                        stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z">
                                        </path>
                        ...
                        <div class="flex flex-1 flex-col overflow-hidden p-4">
                            <div class="flex h-full flex-col">
                                <div x-show="selectedAnnouncement?.image_url"
                                    ...
                                    <img :src="selectedAnnouncement?.image_url" :alt="selectedAnnouncement?.title"
                                ...
                                <div class="shrink-0 overflow-y-auto pr-1"
                                    :class="{
                                        'max-h-[30%]': selectedAnnouncement?.image_url,
                                        'h-full': !selectedAnnouncement
                                            ?.image_url
                                    }">
                                    <div class="prose prose-sm max-w-none dark:prose-invert">
                                        <div class="text-sm text-gray-600 dark:text-gray-300 prose dark:prose-invert max-w-none"
                                            x-html="selectedAnnouncement?.content"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span
                                    ...
                                    <span x-text="currentIndex + 1"></span>/<span
                                        x-text="filteredAnnouncements.length"></span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <button @click="nextAnnouncement()" x-show="currentIndex < filteredAnnouncements.length - 1"
                        x-transition:enter="transition-all duration-300 ease-out"
                        x-transition:enter-start="opacity-0 translate-x-4"
                        x-transition:enter-end="opacity-100 translate-x-0"
