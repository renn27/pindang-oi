...
<x-common.page-breadcrumb pageTitle="{{$title}}" />
    ...
    <!-- Bagian Tahun -->
    <div class="flex flex-row items-center justify-between rounded-2xl border border-gray-200 bg-white p-5 lg:p-6 mb-6">
    ...
    <x-ui.smart-modal id="modal-bidang-kerja" class="max-w-xl"
        ...
        <div class="shrink-0 border-b border-gray-200 px-6 py-3">
            <h4 class="text-2xl font-semibold text-gray-800" x-text="mode === 'create' ? 'Tambah Bidang Kerja' : 'Edit Bidang Kerja'"></h4>
            <p class="mt-1 text-sm text-gray-500" x-text="mode === 'create' ? 'Masukkan bidang kerja baru' : 'Edit bidang kerja yang sudah ada'"></p>
        </div>
