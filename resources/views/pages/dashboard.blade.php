...
@section('content')
    ...
    @if (auth()->user()->isAnggota())
        <div class="mb-8">
            <div
                class="rounded-2xl border border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50 p-6 dark:from-gray-800 dark:to-gray-900 dark:border-gray-700">
    ...
    {{-- ===== SECTION ALL PENILAIAN KARYAWAN ===== --}}
        <div class="w-full">
            @auth
                <x-profile.vis-rank-pegawai :perPage="5" />
            @endauth
        </div>
@endsection
