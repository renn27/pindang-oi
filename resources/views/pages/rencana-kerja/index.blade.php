...
@section('content')
    <x-common.page-breadcrumb pageTitle="Fungsi SPBE" />

    <!-- Bagian Tahun -->
    <div
        class="flex flex-row items-center justify-between rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6 mb-6">
    ...
    <x-ui.modal x-data="{ open: false }" @open-add-subkegiatan-modal.window="open = true" :isOpen="false"
        class="max-w-[700px]">
        <div
            class="relative flex h-[90vh] w-full max-w-[700px] flex-col overflow-hidden
                    rounded-3xl bg-white dark:bg-gray-900">
            ...
            <div class="flex-1 overflow-y-auto px-6 py-5 custom-scrollbar">
                <form class="grid grid-cols-1 gap-y-5">
                    ...
                    <div>
                        ...
                        <x-form.date-picker id="tanggal_mulai" name="date_pick" placeholder="Date Picker"
                    ...
                    <div>
                        ...
                        <x-form.date-picker id="tanggal_akhir" name="date_pick" placeholder="Date Picker"
                            defaultDate="{{ now()->format('Y-m-d') }}" />
                    </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/30">
                            <td
                                class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-300 text-center">
                                1
                            </td>
