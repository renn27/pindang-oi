    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            'dashboardse2026' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M9 17V13" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                <path d="M12 17V10" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                <path d="M15 17V14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                </svg>',
            'sempati' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="2" y="4" width="20" height="14" rx="2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
                ...
                <path d="M6 13L10 9L14 13L18 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
