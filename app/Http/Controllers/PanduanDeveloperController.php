...
class PanduanDeveloperController extends Controller
{
    /**
     * Display the dynamic developer guide documentation.
     */
    public function index(Request $request)
    {
        ...
        // Fetch developer guides for allowed tabs, ordered by sort_order
        ...
        return view('pages.main.panduan-pengguna.developer', [
